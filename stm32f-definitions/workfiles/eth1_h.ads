...
package eth_h is
   ...
   --  unsupported macro: ETH_MACCR_IFG_96Bit
   --  unsupported macro: ETH_MACCR_IFG_88Bit
   --  unsupported macro: ETH_MACCR_IFG_80Bit
   --  unsupported macro: ETH_MACCR_IFG_72Bit
   --  unsupported macro: ETH_MACCR_IFG_64Bit
   --  unsupported macro: ETH_MACCR_IFG_56Bit
   --  unsupported macro: ETH_MACCR_IFG_48Bit
   --  unsupported macro: ETH_MACCR_IFG_40Bit
   ...
   --  unsupported macro: ETH_MACCR_BL_10
   --  unsupported macro: ETH_MACCR_BL_8
   --  unsupported macro: ETH_MACCR_BL_4
   --  unsupported macro: ETH_MACCR_BL_1
   ...
   --  unsupported macro: ETH_MACFFR_PCF_BlockAll
   --  unsupported macro: ETH_MACFFR_PCF_ForwardAll
   --  unsupported macro: ETH_MACFFR_PCF_ForwardPassedAddrFilter
   ...
   --  unsupported macro: ETH_MACMIIAR_CR_Div42
   --  unsupported macro: ETH_MACMIIAR_CR_Div62
   --  unsupported macro: ETH_MACMIIAR_CR_Div16
   --  unsupported macro: ETH_MACMIIAR_CR_Div26
   --  unsupported macro: ETH_MACMIIAR_CR_Div102
   ...
   --  unsupported macro: ETH_MACFCR_PLT_Minus4
   --  unsupported macro: ETH_MACFCR_PLT_Minus28
   --  unsupported macro: ETH_MACFCR_PLT_Minus144
   --  unsupported macro: ETH_MACFCR_PLT_Minus256
   ...
   --  unsupported macro: ETH_DMABMR_RDP_1Beat
   --  unsupported macro: ETH_DMABMR_RDP_2Beat
   --  unsupported macro: ETH_DMABMR_RDP_4Beat
   --  unsupported macro: ETH_DMABMR_RDP_8Beat
   --  unsupported macro: ETH_DMABMR_RDP_16Beat
   --  unsupported macro: ETH_DMABMR_RDP_32Beat
   ...
   --  unsupported macro: ETH_DMABMR_RTPR_1_1
   --  unsupported macro: ETH_DMABMR_RTPR_2_1
   --  unsupported macro: ETH_DMABMR_RTPR_3_1
   --  unsupported macro: ETH_DMABMR_RTPR_4_1
   ...
   --  unsupported macro: ETH_DMASR_EBS_DescAccess
   --  unsupported macro: ETH_DMASR_EBS_ReadTransf
   --  unsupported macro: ETH_DMASR_EBS_DataTransfTx
   --  unsupported macro: ETH_DMASR_TPS
   --  unsupported macro: ETH_DMASR_TPS_Stopped
   --  unsupported macro: ETH_DMASR_TPS_Fetching
   --  unsupported macro: ETH_DMASR_TPS_Waiting
   --  unsupported macro: ETH_DMASR_TPS_Reading
   --  unsupported macro: ETH_DMASR_TPS_Suspended
   --  unsupported macro: ETH_DMASR_TPS_Closing
   --  unsupported macro: ETH_DMASR_RPS
   --  unsupported macro: ETH_DMASR_RPS_Stopped
   --  unsupported macro: ETH_DMASR_RPS_Fetching
   --  unsupported macro: ETH_DMASR_RPS_Waiting
   --  unsupported macro: ETH_DMASR_RPS_Suspended
   --  unsupported macro: ETH_DMASR_RPS_Closing
   --  unsupported macro: ETH_DMASR_RPS_Queuing
  ...
  --   
   ...
   type ETH_TypeDef_RESERVED0_array is array (0 .. 1) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED1_array is array (0 .. 1) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED2_array is array (0 .. 39) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED3_array is array (0 .. 13) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED4_array is array (0 .. 4) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED5_array is array (0 .. 9) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED6_array is array (0 .. 9) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED7_array is array (0 .. 333) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED9_array is array (0 .. 564) of aliased stdint_h.uint32_t;
   type ETH_TypeDef_RESERVED10_array is array (0 .. 7) of aliased stdint_h.uint32_t;
   type ETH_TypeDef is record
      MACCR : aliased stdint_h.uint32_t;  -- eth.h:446
      MACFFR : aliased stdint_h.uint32_t;  -- eth.h:447
      MACHTHR : aliased stdint_h.uint32_t;  -- eth.h:448
      MACHTLR : aliased stdint_h.uint32_t;  -- eth.h:449
      MACMIIAR : aliased stdint_h.uint32_t;  -- eth.h:450
      MACMIIDR : aliased stdint_h.uint32_t;  -- eth.h:451
      MACFCR : aliased stdint_h.uint32_t;  -- eth.h:452
      MACVLANTR : aliased stdint_h.uint32_t;  -- eth.h:453
      RESERVED0 : aliased ETH_TypeDef_RESERVED0_array;  -- eth.h:454
      MACRWUFFR : aliased stdint_h.uint32_t;  -- eth.h:455
      MACPMTCSR : aliased stdint_h.uint32_t;  -- eth.h:456
      RESERVED1 : aliased ETH_TypeDef_RESERVED1_array;  -- eth.h:457
      MACSR : aliased stdint_h.uint32_t;  -- eth.h:458
      MACIMR : aliased stdint_h.uint32_t;  -- eth.h:459
      MACA0HR : aliased stdint_h.uint32_t;  -- eth.h:460
      MACA0LR : aliased stdint_h.uint32_t;  -- eth.h:461
      MACA1HR : aliased stdint_h.uint32_t;  -- eth.h:462
      MACA1LR : aliased stdint_h.uint32_t;  -- eth.h:463
      MACA2HR : aliased stdint_h.uint32_t;  -- eth.h:464
      MACA2LR : aliased stdint_h.uint32_t;  -- eth.h:465
      MACA3HR : aliased stdint_h.uint32_t;  -- eth.h:466
      MACA3LR : aliased stdint_h.uint32_t;  -- eth.h:467
      RESERVED2 : aliased ETH_TypeDef_RESERVED2_array;  -- eth.h:468
      MMCCR : aliased stdint_h.uint32_t;  -- eth.h:469
      MMCRIR : aliased stdint_h.uint32_t;  -- eth.h:470
      MMCTIR : aliased stdint_h.uint32_t;  -- eth.h:471
      MMCRIMR : aliased stdint_h.uint32_t;  -- eth.h:472
      MMCTIMR : aliased stdint_h.uint32_t;  -- eth.h:473
      RESERVED3 : aliased ETH_TypeDef_RESERVED3_array;  -- eth.h:474
      MMCTGFSCCR : aliased stdint_h.uint32_t;  -- eth.h:475
      MMCTGFMSCCR : aliased stdint_h.uint32_t;  -- eth.h:476
      RESERVED4 : aliased ETH_TypeDef_RESERVED4_array;  -- eth.h:477
      MMCTGFCR : aliased stdint_h.uint32_t;  -- eth.h:478
      RESERVED5 : aliased ETH_TypeDef_RESERVED5_array;  -- eth.h:479
      MMCRFCECR : aliased stdint_h.uint32_t;  -- eth.h:480
      MMCRFAECR : aliased stdint_h.uint32_t;  -- eth.h:481
      RESERVED6 : aliased ETH_TypeDef_RESERVED6_array;  -- eth.h:482
      MMCRGUFCR : aliased stdint_h.uint32_t;  -- eth.h:483
      RESERVED7 : aliased ETH_TypeDef_RESERVED7_array;  -- eth.h:484
      PTPTSCR : aliased stdint_h.uint32_t;  -- eth.h:485
      PTPSSIR : aliased stdint_h.uint32_t;  -- eth.h:486
      PTPTSHR : aliased stdint_h.uint32_t;  -- eth.h:487
      PTPTSLR : aliased stdint_h.uint32_t;  -- eth.h:488
      PTPTSHUR : aliased stdint_h.uint32_t;  -- eth.h:489
      PTPTSLUR : aliased stdint_h.uint32_t;  -- eth.h:490
      PTPTSAR : aliased stdint_h.uint32_t;  -- eth.h:491
      PTPTTHR : aliased stdint_h.uint32_t;  -- eth.h:492
      PTPTTLR : aliased stdint_h.uint32_t;  -- eth.h:493
      RESERVED8 : aliased stdint_h.uint32_t;  -- eth.h:494
      PTPTSSR : aliased stdint_h.uint32_t;  -- eth.h:495
      RESERVED9 : aliased ETH_TypeDef_RESERVED9_array;  -- eth.h:496
      DMABMR : aliased stdint_h.uint32_t;  -- eth.h:497
      DMATPDR : aliased stdint_h.uint32_t;  -- eth.h:498
      DMARPDR : aliased stdint_h.uint32_t;  -- eth.h:499
      DMARDLAR : aliased stdint_h.uint32_t;  -- eth.h:500
      DMATDLAR : aliased stdint_h.uint32_t;  -- eth.h:501
      DMASR : aliased stdint_h.uint32_t;  -- eth.h:502
      DMAOMR : aliased stdint_h.uint32_t;  -- eth.h:503
      DMAIER : aliased stdint_h.uint32_t;  -- eth.h:504
      DMAMFBOCR : aliased stdint_h.uint32_t;  -- eth.h:505
      DMARSWTR : aliased stdint_h.uint32_t;  -- eth.h:506
      RESERVED10 : aliased ETH_TypeDef_RESERVED10_array;  -- eth.h:507
      DMACHTDR : aliased stdint_h.uint32_t;  -- eth.h:508
      DMACHRDR : aliased stdint_h.uint32_t;  -- eth.h:509
      DMACHTBAR : aliased stdint_h.uint32_t;  -- eth.h:510
      DMACHRBAR : aliased stdint_h.uint32_t;  -- eth.h:511
   end record;
