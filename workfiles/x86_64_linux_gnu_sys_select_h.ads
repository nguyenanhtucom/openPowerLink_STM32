  ...
  --   __THROW.   
   ...
   function c_select
     (uu_nfds : int;
      ...
      uu_timeout : access x86_64_linux_gnu_bits_time_h.timeval) return int;  -- /usr/include/x86_64-linux-gnu/sys/select.h:109
  ...
  --   __THROW.   
   ...
   function pselect
     (uu_nfds : int;
      ...
      uu_sigmask : access constant x86_64_linux_gnu_bits_sigset_h.uu_sigset_t) return int;  -- /usr/include/x86_64-linux-gnu/sys/select.h:121
